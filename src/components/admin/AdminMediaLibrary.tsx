...
export const AdminMediaLibrary: React.FC<AdminMediaLibraryProps> = ({
  ...
  const [selectedMedia, setSelectedMedia] =
    useState<AdminMediaItem | null>(null);
  ...
  const [deleteConfirmMedia, setDeleteConfirmMedia] =
    useState<AdminMediaItem | null>(null);
        ...
        {filteredMedia.map((media) => (
          ...
          >
            <div>
              ...
              <h4
                className="font-medium text-[#FAF7F2] text-xs truncate mb-1"
                title={
                  media.fileName ||
                  media.name ||
                  ''
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
              ...
              >
                ...
                <p className="text-xs text-[#C9B7C3] leading-relaxed mb-4 font-sans">
                  Replacing this image will
                  update every memory,
                  milestone, place, and capsule
                  currently referencing it across
                  the database.
                </p>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            ...
            >
              ...
              <p className="text-xs text-[#C9B7C3] leading-relaxed mb-6 font-sans">
                This will remove the photo
                from the media library and any
                associated memory galleries.
              </p>
              ...
              <div className="flex items-center justify-center gap-3">
                ...
                <button
                  onClick={async () => {
                    try {
                      await onDeleteMedia(
                        deleteConfirmMedia.id,
                        deleteConfirmMedia.url
                      );
